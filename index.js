 ...
 */
global.findElement = function(arg1, index, attempts) {
  index = index || null;
  attempts = attempts || 0;
  ...
  return (function() {
    ...
    if (element) {
      ...
      return findElement(arg1, index, (attempts + 1));
    } else {
 ...
 * @returns WebdriverElement
 */
global.findInput = function(arg1, attempts) {
  attempts = attempts || 0;
  ...
  return (function() {
    ...
    if (attempts < 5) {
      return findInput(arg1, (attempts + 1));
    } else {
      return e;
    }
  });
 ...
 */
global.resolveParameter = function(arg1) {
