...
module.exports = function() {
  ...
  this.Given(/^I fill in "([^"]*)" with "([^"]*)"$/, function(arg1, arg2, callback) {
    ...
    findInput(arg1).then(function(input) {
      ...
      return input.sendKeys(arg2).then(function() {
  ...
  var select = function(arg1, arg2, index, callback) {
    (function() {
      if (arg2.match(/\..*/)) { // find by class
        return driver.findElements(by.css(arg2));
      } else if (/[A-Z]/.test(arg2[0])) { // find by label if first letter of arg1 is capitalized
        return driver.findElements(by.xpath('//label[text()="' + arg2 + '"]')).then(function(labels) {
        ...
        return browser.findElements(by.css('select[name="' + arg2 + '"]'));
      }
    }()).then(function(selects) {
      return selects[selects.length - (index + 1)];
