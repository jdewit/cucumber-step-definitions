...
module.exports = function() {
  ...
  this.Then(/^model "([^"]*)" should be true$/, function(arg1, callback) {
    var v = browser.element(by.model(arg1));
    v.getText(function(t) {
      console.log('vaaaaaa', t);
    });
    //callback.fail(v.getValue());
     //browser.findElement(by.model(arg1)).then(function(el) {
      //if (el === true) {
        //callback();
      //} else {
        //callback.fail('Expected "' + arg1 + '" to be true');
      //}
    //});
  });
