...
module.exports = function() {
  this.Then(/^I should see the heading "([^"]*)"$/, function(arg1, callback) {
    element(by.tagName('h1')).then(function(el) {
      return el.getText();
    }).then(function(text) {
  ...
  this.Then(/^there should be "([^"]*)" "([^"]*)" elements$/, function(arg1, arg2, callback) {
    utils.findElement(arg2, true).then(function(items) {
      assert.lengthOf(items, arg1);
      callback();
    }, function(e) {
      if (arg1 === "0") {
        callback();
  ...
  this.Then(/^I should see "([^"]*)"$/, function(arg1, callback) {
    utils.findElement(arg1).then(function() {
      callback();
    });
  });
  ...
  this.Then(/^I should see "([^"]*)" within "([^"]*)"$/, function(arg1, arg2, callback) {
    utils.findElement(arg2).then(function(el) {
      return el.findElement(by.xpath('//*[text()="' + arg1 + '"]'));
    }).then(function() {
      callback();
    }, function() {
      callback.fail(arg1 + ' not found within ' + arg2);
    });
  });
  ...
  this.Then(/^the page title should be "([^"]*)"$/, function(arg1, callback) {
    ...
    }, 20000, 'Taking too long to find title').then(function() {
      callback();
    });
  });
